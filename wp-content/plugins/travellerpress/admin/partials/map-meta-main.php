...
<div id="main-point-map-manager">
	...
	<div id="main-point-form">
		<p>
	        ...
	        <input class="regular-text main_point_address" name="main_point_address" type="text" placeholder="<?php esc_attr_e('Address','travellerpress'); ?>" value="<?php echo esc_attr($mpLat); ?>" /> <i><?php esc_attr_e('Address','travellerpress'); ?></i>
	    </p>
	    <p>
	    	<?php $mpLat = get_post_meta($post->ID, 'main_point_latitude', true); ?>
	        <input class="regular-text main_point_latitude" name="main_point_latitude" type="text" placeholder="<?php esc_attr_e('Latitude','travellerpress'); ?>" value="<?php echo esc_attr($mpLat); ?>" /> <i><?php esc_attr_e('Latitude','travellerpress'); ?></i>
	    </p>
	    <p>
			<?php $mpLong = get_post_meta($post->ID, 'main_point_longitude', true); ?>
			<input class="regular-text main_point_longitude" name="main_point_longitude" type="text" placeholder="<?php esc_attr_e('Longitude','travellerpress'); ?>" value="<?php echo esc_attr($mpLong); ?>" /> <i><?php esc_attr_e('Longitude','travellerpress'); ?></i>
	    </p>
	    <p>
		...
		<label for="">Infobox image</label>
		    <a class="main-upload-point-image button <?php if ( $you_have_img  ) { echo 'hidden'; } ?>" 
		...
		<p>
		    <label><?php _e('Title','travellerpress'); ?></label>
		    ...
		    <p class="description">If not specified, post title will be used</p>
		</p>	
	    <p>
	    	<label for="main_point_text"><?php _e('Marker Content','travellerpress'); ?></label>
	    	<i>If not specified, first few words from post content will be used</i>
