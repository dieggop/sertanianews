...
<div id="main-point-map-manager">
	...
	<div id="map-details-tabs">
        <ul class="map-details-tabs">
            ...
            <li><a data-tab="kml" href="#kml"><?php esc_html_e('KLM','travellerpress') ?></a></li>
        </ul>
        ...
        <tr>
            ...
            <td>
                ...
                <select name="map_auto_open" style="width:100%">
                    <option <?php selected($map_auto_open, 'no'); ?> value="no">no</option>
                    <option <?php selected($map_auto_open, 'yes'); ?> value="yes">yes</option>
                </select> 
            </td>
        </tr>    
    </table>
