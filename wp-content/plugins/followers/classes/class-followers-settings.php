		...
		switch ( $section ) {
			...
			case 'apis':
				$settings_fields['facebook_id'] = array(
												...
												'default' => '',
												'section' => 'apis',
												'description' => __( 'You can find it for example here http://findmyfacebookid.com/.', 'followers' )
											);
				...
				$settings_fields['youtube_username'] = array(
												'name' => __( 'YouTube Username', 'followers' ),
												'type' => 'text',
												'default' => '',
												'section' => 'apis',
												'description' => __( 'Just your username ', 'followers' )
